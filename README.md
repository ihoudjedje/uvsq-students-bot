...
Edit the folowing blocs : `all_profs` `profs_plus_ues` `all_ues` `look_for_ue_details` `my_group`
NB: wait a couple seconds after resetting to save the changes automatically 'until the ✔️ appear'

<img src="https://github.com/ilyes16K/ChatBot_nodeJS_TER_Projet/blob/master/Main_App%20(API.AI)/workspace/screenshots/Inkedblocs_webhook_chatfuel.jpg" width="700">
